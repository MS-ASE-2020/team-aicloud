# Generated by Django 3.1.3 on 2020-11-05 05:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(0, 'Uncomitted'), (1, 'Comitted'), (2, 'Done'), (3, 'Notified'), (4, 'Exception')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(0, 'Uncomitted'), (1, 'Comitted'), (2, 'Done'), (3, 'Notified'), (4, 'Exception')], default=0)),
                ('time_created', models.DateTimeField(default=None, help_text='the time when model created; auto-generated', null=True, verbose_name='the create time of model')),
            ],
        ),
        migrations.CreateModel(
            name='Series',
